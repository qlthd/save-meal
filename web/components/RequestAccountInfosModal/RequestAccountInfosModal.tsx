...
import { User, Users, Heart, Building } from "lucide-react";
...
const RequestAccountInfosSchema = z
  ...
  .refine((data) => data.type == "donateur" || data.type == "association", {
...
export function RequestAccountInfosModal({
  open,
  onOpenChange,
}: LoginModalProps) {
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="firstName">
                      Prénom <span className="text-gray-500">(facultatif)</span>
                    </Label>
                    <div className="relative mt-1">
